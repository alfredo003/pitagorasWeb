...
<head>
  ...
  <title>Blog - Colégio Pitágoras</title>
...
<body>
  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top topbar-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <div class="cta">
        <a href="#about" class="scrollto">Inscrição</a>
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html#header" class="scrollto">Pitágoras</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html#header" class="logo mr-auto scrollto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li><a href="index.php#header">Págin Inicial</a></li>
          <li><a href="index.php#about">Sobre Nós</a></li>
          <li><a href="index.php#services">Notícias</a></li>
          <li><a href="index.php#portfolio">Visita Virtual</a></li>
          <li><a href="index.php#team">Direcçaõ</a></li>
          <li><a href="index.php#pricing">Eventos</a></li>
          <li class="active"><a href="blog.php">Blog</a></li>
          <li class="drop-down"><a href="">Cursos</a>
          <ul>
              <li><a href="#">Infermagem Geral</a></li>
              <li class="#"><a href="#">Análises Clínicas</a></li>
